...
public class UserDaoJDBCImpl implements UserDao {
    ...
    private static final String SAVE_USER = "INSERT INTO base100500.superheroes (name, last_name, age) VALUES (?, ?, ?)";
    private static final String REMOVE_USER = "DELETE FROM base100500.superheroes WHERE id=?";
    private static final String GET_USERS = "SELECT * FROM base100500.superheroes";
